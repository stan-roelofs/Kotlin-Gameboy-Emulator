...
class Cartridge : Memory {
    ...
    private fun loadHeader(data: Buffer<Byte>) {
        ...
        val romGraphicBytes = ArrayList<Byte>()
        for (i in 0x104 until 0x134)
            romGraphicBytes.add(data[i])
