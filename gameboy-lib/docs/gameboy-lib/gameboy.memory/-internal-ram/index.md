...
title: InternalRam -
---
//[gameboy-lib](../../index.md)/[gameboy.memory](../index.md)/[InternalRam](index.md)



# InternalRam  
 [jvm] abstract class [InternalRam](index.md) : [Memory](../-memory/index.md)   
...
| <a name="gameboy.memory/Memory/reset/#/PointingToDeclaration/"></a>[reset](../-memory/reset.md)| <a name="gameboy.memory/Memory/reset/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>abstract fun [reset](../-memory/reset.md)()  <br>More info  <br>Resets each memory address to their default value  <br><br><br>
...
|  Name| 
|---|
| <a name="gameboy.memory/InternalRamCGB///PointingToDeclaration/"></a>[InternalRamCGB](../-internal-ram-c-g-b/index.md)
| <a name="gameboy.memory/InternalRamDMG///PointingToDeclaration/"></a>[InternalRamDMG](../-internal-ram-d-m-g/index.md)
