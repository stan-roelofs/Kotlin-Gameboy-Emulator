...
---
//[gameboy-lib](../../index.md)/[gameboy.memory](../index.md)/[InternalRamCGB](index.md)



# InternalRamCGB  
 [jvm] class [InternalRamCGB](index.md) : [InternalRam](../-internal-ram/index.md)   
...
| <a name="gameboy.memory/InternalRamCGB/readByte/#kotlin.Int/PointingToDeclaration/"></a>[readByte](read-byte.md)| <a name="gameboy.memory/InternalRamCGB/readByte/#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [readByte](read-byte.md)(address: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br>More info  <br>Reads an 8-bit value at address  <br><br><br>
...
| <a name="gameboy.memory/InternalRamCGB/reset/#/PointingToDeclaration/"></a>[reset](reset.md)| <a name="gameboy.memory/InternalRamCGB/reset/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [reset](reset.md)()  <br>More info  <br>Resets each memory address to their default value  <br><br><br>
...
| <a name="gameboy.memory/InternalRamCGB/writeByte/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[writeByte](write-byte.md)| <a name="gameboy.memory/InternalRamCGB/writeByte/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [writeByte](write-byte.md)(address: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), value: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Writes an 8-bit value to address  <br><br><br>
