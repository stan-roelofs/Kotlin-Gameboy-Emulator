...
title: RR -
---
//[gameboy-lib](../../index.md)/[gameboy.cpu.instructions.rotates](../index.md)/[RR](index.md)



# RR  
 [jvm] abstract class [RR](index.md)(**registers**: [Registers](../../gameboy.cpu/-registers/index.md), **mmu**: [Mmu](../../gameboy.memory/-mmu/index.md)) : [Instruction](../../gameboy.cpu.instructions/-instruction/index.md)   
...
| <a name="gameboy.cpu.instructions.rotates/RR/reset/#/PointingToDeclaration/"></a>[reset](reset.md)| <a name="gameboy.cpu.instructions.rotates/RR/reset/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [reset](reset.md)()  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="gameboy.cpu.instructions.rotates/RR/mmu/#/PointingToDeclaration/"></a>[mmu](mmu.md)| <a name="gameboy.cpu.instructions.rotates/RR/mmu/#/PointingToDeclaration/"></a> [jvm] val [mmu](mmu.md): [Mmu](../../gameboy.memory/-mmu/index.md)   <br>
| <a name="gameboy.cpu.instructions.rotates/RR/registers/#/PointingToDeclaration/"></a>[registers](registers.md)| <a name="gameboy.cpu.instructions.rotates/RR/registers/#/PointingToDeclaration/"></a> [jvm] val [registers](registers.md): [Registers](../../gameboy.cpu/-registers/index.md)   <br>
| <a name="gameboy.cpu.instructions.rotates/RR/totalCycles/#/PointingToDeclaration/"></a>[totalCycles](total-cycles.md)| <a name="gameboy.cpu.instructions.rotates/RR/totalCycles/#/PointingToDeclaration/"></a> [jvm] abstract val [totalCycles](total-cycles.md): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
...
|  Name| 
|---|
| <a name="gameboy.cpu.instructions.rotates/RRA///PointingToDeclaration/"></a>[RRA](../-r-r-a/index.md)
| <a name="gameboy.cpu.instructions.rotates/RR_HL///PointingToDeclaration/"></a>[RR_HL](../-r-r_-h-l/index.md)
| <a name="gameboy.cpu.instructions.rotates/RR_r///PointingToDeclaration/"></a>[RR_r](../-r-r_r/index.md)
