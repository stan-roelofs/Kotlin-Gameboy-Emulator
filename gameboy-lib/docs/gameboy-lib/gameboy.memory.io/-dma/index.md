...
title: Dma -
---
//[gameboy-lib](../../index.md)/[gameboy.memory.io](../index.md)/[Dma](index.md)



# Dma  
 [jvm] class [Dma](index.md)(**mmu**: [Mmu](../../gameboy.memory/-mmu/index.md)) : [Memory](../../gameboy.memory/-memory/index.md)   
...
| <a name="gameboy.memory.io/Dma/getOamAccessible/#/PointingToDeclaration/"></a>[getOamAccessible](get-oam-accessible.md)| <a name="gameboy.memory.io/Dma/getOamAccessible/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>fun [getOamAccessible](get-oam-accessible.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)  <br><br><br>
...
| <a name="gameboy.memory.io/Dma/reset/#/PointingToDeclaration/"></a>[reset](reset.md)| <a name="gameboy.memory.io/Dma/reset/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [reset](reset.md)()  <br>More info  <br>Resets each memory address to their default value  <br><br><br>
| <a name="gameboy.memory.io/Dma/tick/#kotlin.Int/PointingToDeclaration/"></a>[tick](tick.md)| <a name="gameboy.memory.io/Dma/tick/#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>fun [tick](tick.md)(cycles: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br><br><br>
...
| <a name="gameboy.memory.io/Dma/writeByte/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[writeByte](write-byte.md)| <a name="gameboy.memory.io/Dma/writeByte/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [writeByte](write-byte.md)(address: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), value: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Writes an 8-bit value to address  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="gameboy.memory.io/Dma/inProgress/#/PointingToDeclaration/"></a>[inProgress](in-progress.md)| <a name="gameboy.memory.io/Dma/inProgress/#/PointingToDeclaration/"></a> [jvm] var [inProgress](in-progress.md): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) = false   <br>
