...
title: ADD -
---
//[gameboy-lib](../../index.md)/[gameboy.cpu.instructions.alu](../index.md)/[ADD](index.md)



# ADD  
 [jvm] abstract class [ADD](index.md)(**registers**: [Registers](../../gameboy.cpu/-registers/index.md), **mmu**: [Mmu](../../gameboy.memory/-mmu/index.md)) : [Instruction](../../gameboy.cpu.instructions/-instruction/index.md)   
...
| <a name="gameboy.cpu.instructions.alu/ADD/reset/#/PointingToDeclaration/"></a>[reset](reset.md)| <a name="gameboy.cpu.instructions.alu/ADD/reset/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [reset](reset.md)()  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="gameboy.cpu.instructions.alu/ADD/mmu/#/PointingToDeclaration/"></a>[mmu](mmu.md)| <a name="gameboy.cpu.instructions.alu/ADD/mmu/#/PointingToDeclaration/"></a> [jvm] val [mmu](mmu.md): [Mmu](../../gameboy.memory/-mmu/index.md)   <br>
| <a name="gameboy.cpu.instructions.alu/ADD/registers/#/PointingToDeclaration/"></a>[registers](registers.md)| <a name="gameboy.cpu.instructions.alu/ADD/registers/#/PointingToDeclaration/"></a> [jvm] val [registers](registers.md): [Registers](../../gameboy.cpu/-registers/index.md)   <br>
| <a name="gameboy.cpu.instructions.alu/ADD/totalCycles/#/PointingToDeclaration/"></a>[totalCycles](total-cycles.md)| <a name="gameboy.cpu.instructions.alu/ADD/totalCycles/#/PointingToDeclaration/"></a> [jvm] abstract val [totalCycles](total-cycles.md): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
...
|  Name| 
|---|
| <a name="gameboy.cpu.instructions.alu/ADD_A_HL///PointingToDeclaration/"></a>[ADD_A_HL](../-a-d-d_-a_-h-l/index.md)
| <a name="gameboy.cpu.instructions.alu/ADD_A_n///PointingToDeclaration/"></a>[ADD_A_n](../-a-d-d_-a_n/index.md)
| <a name="gameboy.cpu.instructions.alu/ADD_A_r///PointingToDeclaration/"></a>[ADD_A_r](../-a-d-d_-a_r/index.md)
| <a name="gameboy.cpu.instructions.alu/ADD_HL_rr///PointingToDeclaration/"></a>[ADD_HL_rr](../-a-d-d_-h-l_rr/index.md)
| <a name="gameboy.cpu.instructions.alu/ADD_SP_n///PointingToDeclaration/"></a>[ADD_SP_n](../-a-d-d_-s-p_n/index.md)
