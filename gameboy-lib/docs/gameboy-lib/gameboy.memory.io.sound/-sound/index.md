...
title: Sound -
---
//[gameboy-lib](../../index.md)/[gameboy.memory.io.sound](../index.md)/[Sound](index.md)



# Sound  
 [jvm] class [Sound](index.md) : [Memory](../../gameboy.memory/-memory/index.md)   
...
| <a name="gameboy.memory.io.sound/Sound/readByte/#kotlin.Int/PointingToDeclaration/"></a>[readByte](read-byte.md)| <a name="gameboy.memory.io.sound/Sound/readByte/#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [readByte](read-byte.md)(address: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br>More info  <br>Reads an 8-bit value at address  <br><br><br>
...
| <a name="gameboy.memory.io.sound/Sound/reset/#/PointingToDeclaration/"></a>[reset](reset.md)| <a name="gameboy.memory.io.sound/Sound/reset/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [reset](reset.md)()  <br>More info  <br>Resets each memory address to their default value  <br><br><br>
| <a name="gameboy.memory.io.sound/Sound/tick/#kotlin.Int/PointingToDeclaration/"></a>[tick](tick.md)| <a name="gameboy.memory.io.sound/Sound/tick/#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>fun [tick](tick.md)(cycles: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br><br><br>
...
| <a name="gameboy.memory.io.sound/Sound/writeByte/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[writeByte](write-byte.md)| <a name="gameboy.memory.io.sound/Sound/writeByte/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>open override fun [writeByte](write-byte.md)(address: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), value: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Writes an 8-bit value to address  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="gameboy.memory.io.sound/Sound/optionChannelEnables/#/PointingToDeclaration/"></a>[optionChannelEnables](option-channel-enables.md)| <a name="gameboy.memory.io.sound/Sound/optionChannelEnables/#/PointingToDeclaration/"></a> [jvm] var [optionChannelEnables](option-channel-enables.md): [Array](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-array/index.html)<[Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)>   <br>
| <a name="gameboy.memory.io.sound/Sound/output/#/PointingToDeclaration/"></a>[output](output.md)| <a name="gameboy.memory.io.sound/Sound/output/#/PointingToDeclaration/"></a> [jvm] var [output](output.md): [SoundOutput](../-sound-output/index.md)? = null   <br>
